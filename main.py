...
def threaded_function():
    while(True):
        ...
        if camera > 32000:
            gamepad.press_button(vg.XUSB_BUTTON.XUSB_GAMEPAD_DPAD_UP) #restart race
        if camera < -32000:
            gamepad.press_button(vg.XUSB_BUTTON.XUSB_GAMEPAD_DPAD_DOWN) #recover drone
        if camera == 0:
...
try:
    ...
    while True:
        ...
        if len(data) == 58:
            bytes_ = data[28:30]
            ival = int.from_bytes(bytes_, byteorder="big")
